  ...
  return (
    <>
      <div className='flex flex-col items-center justify-center h-screen pb-40 bg-gradient-to-r from-purple-200 to-pink-200'>
        ...
        <button onClick={()=> navigate('/gameplay')} className='w-1/4 m-2.5 inline-flex items-center justify-center rounded-xl p-2.5 text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:scale-95 transform cursor-pointer'>Start Game</button>
